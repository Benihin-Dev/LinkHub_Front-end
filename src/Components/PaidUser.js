    ...
    return (
      <>
        ...
        <div
          ...
          } mx-4 sm:w-10/12 lg:w-8/12 ${isMounted ? "slide-in" : ""} opacity-0`}
        >
          <div className="sm:w-7/12 lg:w-6/12 lg:mx-8 mt-4 sm:mt-10">
            {accountState === true ? (
              <div
                className={` h-full ${isMounted ? "slide-in" : ""} opacity-0`}
              >
                  ...
                  <div className="acc_block">
                    ...
                    <div className="links links_start">
                      ...
                      <textarea
                        ...
                        onChange={(event) =>
                          handleUpdateChange(event, "youtube")
                        }
                      />
                    </div>
                    <div className="links links_end">
                    ...
                    <div className="links links_start">
                      ...
                      <textarea
                        ...
                        onChange={(event) =>
                          handleUpdateChange(event, "tiktok")
                        }
                      />
                    </div>
                    <div className="links links_end">
                      ...
                      <textarea
                        ...
                        onChange={(event) =>
                          handleUpdateChange(event, "reddit")
                        }
                      />
                    </div>
                    <div className="links links_start">
                    ...
                    <div className="links links_end">
                      ...
                      <textarea
                        ...
                        onChange={(event) =>
                          handleUpdateChange(event, "threads")
                        }
                      />
                    </div>
                    <div className="links links_start">
                      ...
                      <textarea
                        ...
                        onChange={(event) =>
                          handleUpdateChange(event, "flickr")
                        }
                      />
                    </div>
                    <div className="links links_end">
                      ...
                      <textarea
                        ...
                        onChange={(event) =>
                          handleUpdateChange(event, "github")
                        }
                      />
                    </div>
                    <div className="links links_start">
                    ...
                    <div className="links links_end">
                      ...
                      <textarea
                        ...
                        onChange={(event) =>
                          handleUpdateChange(event, "meetup")
                        }
                      />
                    </div>
                    <div className="links links_start">
                    ...
                    <div className="links links_end">
                      ...
                      <textarea
                        ...
                        onChange={(event) =>
                          handleUpdateChange(event, "fiverr")
                        }
                      />
                    </div>
                    <div className="links links_start">
                      ...
                      <textarea
                        ...
                        onChange={(event) =>
                          handleUpdateChange(event, "tinder")
                        }
                      />
                    </div>
                    <div className="links links_end">
                      ...
                      <textarea
                        ...
                        onChange={(event) =>
                          handleUpdateChange(event, "tumblr")
                        }
                      />
                    </div>
                    <div className="links links_start">
