...
export default function Login() {
  ...
  const [wrongUsernamePasswordText, setwrongUsernamePasswordText] =
    useState("");
  const [wrongUsernameAlert, setwrongUsernameAlert] = useState(
    "border-[#5b5b5b7e] border-b"
  );
  ...
  const HandleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (
          wrongUsernameAlert ===
          "border-red-400 border-b-2 shadow-md shadow-red-100"
        ) {
  ...
  return (
    <>
      ...
      <div
        className={` ${
          isMounted ? "slide-in" : ""
        } opacity-0 font-Sriracha sm:flex sm:w-9/12  md:w-8/12 lg:w-2/4 h-96 mx-auto pt-20 sm:pt-20 md:pt-32 lg:pt-40`}
      >
        <div className="py-5 sm:px-5 w-10/12 mx-auto md:px-0 lg:pt-1 sm:mt-auto sm:mb-16 lg:mt-auto lg:mb-5 md:pt-16 lg:w-6/12 ">
          <p className="text-slate-500 text-sm lg:pr-20">
            ...
            <br />{" "}
            <span className="text-sm text-[#f3a775]">
        ...
        <div className="lg:w-6/12 w-10/12 mx-auto relative mt-7 mb-20 lg:mt-0">
          <form action="#" onSubmit={HandleSubmit} className={` relative`}>
            <div className={`${loading === true ? "blur" : "blur-none"}`}>
              ...
              <div
                className={`flex mb-4 mx-auto w-10/12 sm:w-10/12 ${wrongUsernameAlert} overflow-hidden`}
              >
                ...
                <input
                  className="px-3 w-10/12 pt-3 pb-1 text-sm sm:w-11/12 lg:w-10/12 outline-none  bg-[#00ffcc0c] hover:bg-white duration-500"
                  type="text"
                  name="username"
                  id="username"
              ...
              <div
                className={`flex mb-4 mx-auto w-10/12 sm:w-10/12 ${wrongPasswordAlert} overflow-hidden`}
              >
                <div className="w-2/12 sm:w-2/12 lg:w-2/12 border-r bg-[#51fbd90e] border-[#3c3d3d1f] flex justify-center items-center">
                  <img src={logImg} alt="userImg" className="size-5 " />
                </div>
                <input
                  className="px-3 w-9/12 pt-3 pb-1 text-sm sm:w-10/12 lg:w-9/12 outline-none  bg-[#00ffcc0c] hover:bg-white duration-500"
              ...
              <div className="flex mb-2 mx-auto w-10/12 sm:w-10/12  border-[#00ffca] rounded overflow-hidden">
                <input
                  className="px-3 cursor-pointer text-sm w-full pt-2 pb-1 outline-none font-bold bg-[#00ffcc49] hover:bg-[#00ffca] duration-500"
                  type="submit"
                  value="SIGN IN"
                />
              </div>
          ...
          <div className="w-10/12 flex mx-auto items-center">
            ...
            <NavLink to="/account-selection">
              <button className="text-[#ffa96f] text-sm sm:px-1">
                {" "}
                Sign up
              </button>
            </NavLink>
